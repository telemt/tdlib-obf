...
const char *linux_config_json() {
  return "{"
         "\"version\":1,"
         "\"platform_hints\":{\"device_class\":\"desktop\",\"mobile_os\":\"none\",\"desktop_os\":\"linux\"},"
         "\"flow_behavior\":{\"max_connects_per_10s_per_destination\":6,\"min_reuse_ratio\":0.55,\"min_conn_lifetime_"
         "ms\":1500,\"max_conn_lifetime_ms\":180000,\"max_destination_share\":0.70,\"sticky_domain_rotation_window_"
         "sec\":900,\"anti_churn_min_reconnect_interval_ms\":300},"
         "\"profile_weights\":{\"allow_cross_class_rotation\":false,\"desktop_darwin\":{\"Chrome133\":35,\"Chrome131\":"
...
const char *android_config_json() {
  return "{"
         "\"version\":1,"
         "\"platform_hints\":{\"device_class\":\"mobile\",\"mobile_os\":\"android\",\"desktop_os\":\"unknown\"},"
         "\"flow_behavior\":{\"max_connects_per_10s_per_destination\":6,\"min_reuse_ratio\":0.55,\"min_conn_lifetime_"
         "ms\":1500,\"max_conn_lifetime_ms\":180000,\"max_destination_share\":0.70,\"sticky_domain_rotation_window_"
         "sec\":900,\"anti_churn_min_reconnect_interval_ms\":300},"
         "\"profile_weights\":{\"allow_cross_class_rotation\":false,\"desktop_darwin\":{\"Chrome133\":35,\"Chrome131\":"
...
TEST(StealthParamsLoaderPlatformDriftStress, RepeatedPlatformMutationAttemptsNeverReplaceLastKnownGoodSnapshot) {
  ...
  for (td::uint32 i = 0; i < 64; i++) {
    write_file(path, td::Slice(android_config_json()));
    ...
    ASSERT_TRUE(platform.desktop_os == DesktopOs::Linux);
