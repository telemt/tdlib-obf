...
class GenerateImportedFixtureRegistryProfileAggregationAdversarialTest(
    unittest.TestCase
):
    def test_rejects_conflicting_browser_alias_for_same_profile(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with self.assertRaisesRegex(ValueError, "conflicting browser aliases"):
                refresh_imported_candidate_corpus(
                    clienthello_root,
                    serverhello_root,
                    manifest_path,
