...
def write_clienthello_artifact(
    ...
    *,
    ...
    payload = {
        ...
        "os_family": "windows",
        "transport": "tcp",
        "fixture_family_id": artifact_family,
        "samples": [
            {
                "fixture_id": f"{profile_id}:frame1",
                "fixture_family_id": sample_family,
...
class GenerateImportedFixtureRegistryFamilyAdversarialTest(unittest.TestCase):
    def test_rejects_sample_family_override_that_conflicts_with_artifact_family(
        self,
    ) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            write_clienthello_artifact(
                ...
                source_path=capture,
                artifact_family="chrome146_windows_test",
                sample_family="firefox149_windows_test",
            )
            ...
            with self.assertRaisesRegex(
                ValueError, "fixture_family_id must match profile_id"
            ):
