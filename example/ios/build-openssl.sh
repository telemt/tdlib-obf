...
if ! git fetch --depth 1 origin "$PYTHON_APPLE_SUPPORT_COMMIT"; then
	echo "Warning: shallow fetch for pinned Python-Apple-support commit failed; retrying with full fetch."
